...
@NoArgsConstructor
@Data
public class CompleteEventBookingResult {
    private String code;
    ...
    public CompleteEventBookingResult(String code, String message) {
        this.code = code;
        this.message = message;
    }

    public CompleteEventBookingResult(Object validationResult, String code, String message) {
