...
@NoArgsConstructor
@Data
public class CompleteMovieBookingResult {
    private String code;
    ...
    public CompleteMovieBookingResult(String code, String message) {
        this.code = code;
        this.message = message;
    }

    public CompleteMovieBookingResult(Object validationResult, String code, String message) {
